...
def finish_deposit():
    ...
    current_balance_label.config(text="Current Balance : रु॰"+str(updated_balance),fg="green")
...
def withdraw():
    ...
    current_balance_label = Label(withdraw_screen, text="Current Balance : रु॰"+details_balance, font=('Calibri',12))
    current_balance_label.grid(row=1,sticky=W)
...
def personal_details():
    ...
    Label(personal_details_screen, text="Balance :रु॰"+details_balance, font=('Calibri',12)).grid(row=4,sticky=W)
def login():
    #Vars
...
#Image import
img = Image.open('C:\\Users\\91798\\OneDrive\\Desktop\\Bank Management System in Python\\nrb.jpg')
img = img.resize((150,150))
img = ImageTk.PhotoImage(img)

#Labels
Label(master, text = "नेपाल राष्ट्र बैंक", font=('Calibri',14)).grid(row=0,sticky=N,pady=10)
Label(master, text = "बैंक पन्नी साथि पन्नी, रामरो पन्नी हाम्रो पन्नी", font=('Calibri',12)).grid(row=1,sticky=N)
